...
namespace DAL
{
    public class StudentService
    {
        ...
        public int AddStudent(Student objStudent)
        {
            ...
            sqlBuilder.Append("StudentIdNo,Age,PhoneNumber,StudentAdress,CardNo,ClassId,StuImage)");
            ...
            string sql = string.Format(sqlBuilder.ToString(), objStudent.StudentName,
                    ...
                    objStudent.PhoneNumber, objStudent.StudentAdress, objStudent.CardNo,
        ...
        public StudentExt GetStudentById(string studentId)
        {
            ...
            sql += "StudentIdNo,PhoneNumber,StudentAdress,CardNo,StuImage from Students";
            sql += " inner join StudentClass on Students.ClassId=StudentClass.ClassId ";
            ...
            if (objReader.Read())
            {
                objStudent = new StudentExt()
                {
                    ...
                    StudentIdNo = objReader["StudentIdNo"].ToString(),
                    PhoneNumber = objReader["PhoneNumber"].ToString(),
                    StudentAdress = objReader["StudentAdress"].ToString(),
        ...
        {   //【1】编写SQL语句
            ...
            sqlBuilder.Append(
                "StudentIdNo={3},Age={4},PhoneNumber='{5}',StudentAdress='{6}',CardNo='{7}',ClassId={8},StuImage='{9}'");
